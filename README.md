...
Electronics & Communication Engineering student interested in **Embedded Systems, FPGA Design, Digital VLSI, and Industrial Automation**.

Focused on building practical hardware-oriented projects and exploring the interaction between **embedded software, digital hardware, and electronic systems**.

- 🔭 Currently working on **FPGA Design**, **Embedded Systems**, **Digital VLSI**, and **Industrial Automation**
...
CNN inference implemented using **Verilog HDL and FPGA hardware**, targeting low-latency edge AI applications.

**Technologies:** Verilog HDL · FPGA · Xilinx Vivado
...
Industrial automation work involving **PLC, Siemens TIA Portal, HMI, OPC-UA, AWS IoT, and Node-RED**.

**Technologies:** PLC · HMI · TIA Portal · IoT
...
### 🔌 LPC2148 UART Vending Machine

UART-based vending machine simulation using **Embedded C and ARM LPC2148**.

**Technologies:** Embedded C · LPC2148 · UART
...
File handling and text processing project implemented in **C on Linux**.

**Technologies:** C · Linux · File Handling
